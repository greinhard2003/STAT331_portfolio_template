...
The main way I have extended my thinking is by exploring what ggplot2 has to offer. I have spent the most time researching how to tweak the colors of the different parts of my plots. I find it a little difficult to be creative with my plots so I have been trying to force myself to play with the colors in order to get better at it. The other way I have extended my thinking is by using the "?function_name()" functionality within Rstudio in order to learn about a new function or remind myself how to use one instead of googling the function or asking ChatGPT what it does. I have found that the built in documentation is usually enough if not more than I need to figure out how the function works and what it will allow me to do. This has also helped me avoid superseded and deprecated functions. 
